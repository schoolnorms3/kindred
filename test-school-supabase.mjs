...
async function test() {
  const { data, error } = await supabase.from('schools').select('id, name, slug, image_url, gallery:school_gallery(image_url)').eq('slug', 'cathedral-and-john-connon-school').single()
